  ...
  if (backend) {
    ...
    while (input === "" || input === null) {
      ...
      if (input !== null) {
        ...
        console.log("Navigating to: /level-zero-bs");
        router.replace("/level-zero-bs"); // Hardcoded route
      } else {
...
function BSButton({ route, start }: { route: string; start?: boolean }) {
